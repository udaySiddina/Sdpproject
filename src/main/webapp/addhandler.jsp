    ...
    <div class="row">
        ...
        <div class="col-7">
            <div class="container">
                ...
                <br><br>
                <h1 style="color: white;">Add Handler</h1>
                <form class="row g-3" style="color: white;" method="post" action="handlerreg">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select form-select mb-3" aria-label="Large select example" name="grptype">
                    ...
                    <div class="col-md-6">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary" style="background-color: #98B545;" value="Register">Add Handler</button>
                        </div>
                    </div>
                </form>
            </div>
