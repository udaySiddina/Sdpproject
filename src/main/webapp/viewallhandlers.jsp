...
<body style="background-color: #013329;">
    <div class="container">
		...
		<thead>
  		...
  		<tbody>
  			M<c:forEach items="${hlist}" var="h">
    		<tr>
      			<th scope="row">${h.id}</th>
      			<td><c:out value="${h.fname}" /></td>
      			<td><c:out value="${h.lname}" /></td>
      			<td><c:out value="${h.gender}" /></td>
      			<td><c:out value="${h.dob}" /></td>
      			<td><c:out value="${h.email}" /></td>
      			<td><c:out value="${h.grptype}" /></td>
    		</tr>
    		</c:forEach>
